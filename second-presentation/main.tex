...
\title[]{Отладка Stream API в среде разработки IntelliJ IDEA} % The short title appears at the bottom of every slide, the full title is only on the title page
