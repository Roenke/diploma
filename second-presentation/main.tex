...
\title[]{Отладчик Stream API для языка программирования Java в среде разработки IntelliJ IDEA} % The short title appears at the bottom of every slide, the full title is only on the title page
