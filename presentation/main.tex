...
\title[Stream Debugger]{Отладчик Stream API языка программирования Java} % The short title appears at the bottom of every slide, the full title is only on the title page
